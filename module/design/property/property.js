  ...
  define('module/design/property/vpc/view',['../base/view', './template/stack', 'i18n!nls/lang.js', 'dhcp', 'UI.modalplus'], function(PropertyView, template, lang, dhcp, modalPlus) {
    ...
    VPCView = PropertyView.extend({
      ...
      initDhcpSelection: function() {
        ...
        currentVal = this.model.toJSON().dhcp.appId;
        if (currentVal === '') {
          selection = {
            isAuto: true
          };
...
(function() {
  define('module/design/property/vpc/app_model',['../base/model', "Design", 'constant', "CloudResources"], function(PropertyModel, Design, constant, CloudResources) {
    var VPCAppModel;
...
(function() {
  define('module/design/property/asg/app_view',['../base/view', './template/app', './template/policy', './template/term', 'i18n!nls/lang.js', 'sns_dropdown', 'UI.modalplus'], function(PropertyView, template, policy_template, term_template, lang, snsDropdown, modalplus) {
