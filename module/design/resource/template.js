...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<a href=\"javascript:void(0)\" id=\"hide-resource-panel\" class=\"tooltip sidebar-hider icon-caret-left\" data-tooltip='"
    ...
    + "\r\n	<i class=\"js-toggle-dropdown menu-manage-shard-res icon-resources\"></i>\r\n	<ul class=\"dropdown-menu resources-dropdown-wrapper\">\r\n		<li data-action=\"keypair\">"
    + escapeExpression(helpers.i18n.call(depth0, "RES_TIT_RESOURCES_MENU_KEYPAIR", {hash:{},data:data}))
    + "</li>\r\n		<li data-action=\"snapshot\">"
    + escapeExpression(helpers.i18n.call(depth0, "RES_TIT_RESOURCES_MENU_SNAPSHOT", {hash:{},data:data}))
    + "</li>\r\n		<li data-action=\"sns\">"
    + escapeExpression(helpers.i18n.call(depth0, "RES_TIT_RESOURCES_MENU_SNS", {hash:{},data:data}))
    + "</li>\r\n		<li data-action=\"sslcert\">"
    + escapeExpression(helpers.i18n.call(depth0, "RES_TIT_RESOURCES_MENU_SSLCERT", {hash:{},data:data}))
    + "</li>\r\n		<li data-action=\"dhcp\">"
    + escapeExpression(helpers.i18n.call(depth0, "RES_TIT_RESOURCES_MENU_DHCP", {hash:{},data:data}))
