...
function program5(depth0,data) {
  ...
  buffer += "'><i class=\"icon-bezier-qt\"></i><span>"
    ...
    + "</span></li>\n  </ul>\n</div>\n<!--\n<button class=\"btn-toolbar tooltip ";
  stack1 = helpers.unless.call(depth0, ((stack1 = (depth0 && depth0.item_flags)),stack1 == null || stack1 === false ? stack1 : stack1.can_save_as_app), {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\" data-tooltip='"
    + escapeExpression(helpers.i18n.call(depth0, "TOOL_SAVE_AS_APP", {hash:{},data:data}))
    + "' id=\"toolbar-save-as-app\"  ";
  stack1 = helpers.unless.call(depth0, ((stack1 = (depth0 && depth0.item_flags)),stack1 == null || stack1 === false ? stack1 : stack1.can_save_as_app), {hash:{},inverse:self.noop,fn:self.program(3, program3, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += " ></button>\n-->";
  return buffer;
