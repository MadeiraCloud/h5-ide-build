...
(function() {
  ...
  define('appAction',["backbone", "component/AppAction/template", 'i18n!/nls/lang.js', 'CloudResources', 'constant', 'UI.modalplus', 'ApiRequest'], function(Backbone, AppTpl, lang, CloudResources, constant, modalPlus, ApiRequest) {
    var AppAction;
    AppAction = Backbone.View.extend({
      ...
      startApp: function(id) {
        ...
        return ApiRequest("app_info", {
          ...
          return opsModel.__setJsonData(ds[0]);
        }).then(function() {
          var comp, dbInstance, hasASG, hasDBInstance, hasEC2Instance, name, snapshots;
  ...
  define('og_manage',['constant', 'CloudResources', 'toolbar_modal', './component/optiongroup/ogTpl', 'i18n!/nls/lang.js', 'event', 'UI.modalplus'], function(constant, CloudResources, toolbar_modal, template, lang, ide_event, modalplus) {
    ...
    return Backbone.View.extend({
      ...
      render: function() {
        ...
        ogData.appId = this.ogModel.get('appId');
