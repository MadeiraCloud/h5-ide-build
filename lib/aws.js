    ...
    genAttrRefList = function(currentCompData, allCompData) {
      ...
      if (cloudType === 'aws') {
        ...
        _.each(allListenerModels, function(listenerModel) {
          ...
          return resAttrDataAry = resAttrDataAry.concat([_genRefObj(name, uid, 'cidr'), _genRefObj(name, uid, 'protocol'), _genRefObj(name, uid, 'port')]);
        });
        ...
        _.each(allSubnetModels, function(subnetModel) {
          ...
          uid = subnetModel.id;
          return resAttrDataAry = resAttrDataAry.concat([_genRefObj(name, uid, 'ip_address'), _genRefObj(name, uid, 'gateway_ip')]);
        });
      }
