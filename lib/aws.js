(function() {
  ...
  define(['MC', 'constant', 'underscore', 'jquery', 'Design', 'i18n!/nls/lang.js'], function(MC, constant, _, $, Design, lang) {
    ...
    genAttrRefList = function(currentCompData, allCompData) {
      var allAttrStrAry, allListenerModels, allPortModels, allSubnetModels, autoCompList, awsPropertyData, cloudType, currentASGName, currentCompType, currentCompUID, currentISGName, currentInstanceName, currentIsASG, currentIsISG, currentIsInstance, currentResModel, groupAutoCompList, instanceAutoCompList, lcUID, lcUIDRef, resAttrDataAry, _genRefObj, _getSelectedASGModelByLC;
