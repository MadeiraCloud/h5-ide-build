(function() {
  ...
  define(['MC', 'constant', 'underscore', 'jquery', 'Design', 'i18n!/nls/lang.js'], function(MC, constant, _, $, Design, lang) {
    ...
    genAttrRefList = function(currentCompData, allCompData) {
      var autoCompList, awsPropertyData, currentASGName, currentCompType, currentCompUID, currentISGName, currentInstanceName, currentIsASG, currentIsISG, currentIsInstance, groupAutoCompList, instanceAutoCompList, lcUID, lcUIDRef, resAttrDataAry, _getSelectedASGModelByLC;
