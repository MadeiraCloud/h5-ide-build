(function() {
  ...
  define(['MC', 'constant', 'underscore', 'jquery', 'Design'], function(MC, constant, _, $, Design) {
    var checkPrivateIPIfHaveEIP, genAttrRefList, getCompByResIdForState, isValidInIPRange;
