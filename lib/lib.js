...
(function() {
  define('constant',['i18n!nls/lang.js'], function(lang) {
    var APP_STATE, AWS_PORT_NAME, AWS_RESOURCE, AWS_RESOURCE_KEY, AWS_RESOURCE_SHORT_TYPE, AWS_RESOURCE_TYPE, COOKIE_OPTION, DEMO_STACK_NAME_LIST, INSTANCE_STATES, INSTANCE_TYPE, LINUX, LOCAL_COOKIE_OPTION, MESSAGE_E, OPS_STATE, OS_TYPE, OS_TYPE_MAPPING, RDP_TMPL, RECENT_DAYS, RECENT_NUM, REGEXP, REGION_KEYS, REGION_LABEL, REGION_SHORT_LABEL, RESTYPE, RETURN_CODE, SERVICE_REGION, TA, WINDOWS;
    AWS_RESOURCE_KEY = {
    ...
    AWS_PORT_NAME = {
      ...
      INSTANCE_ATTACH: "instance_attach",
      ELB_SG_IN: "elb_sg_in",
      ELB_SG_OUT: "elb_sg_out",
      ELB_ATTACH: "elb_attach",
      SUBNET_ATTACH: "subnet_attach",
      SUBNET_ACL: "subnet_acl",
      RTB_SRC: "rtb_src",
    ...
    SERVICE_REGION = [];
    SERVICE_REGION['us-east-1'] = ['cloudfront', 'cloudsearch-us-east-1', 'cloudwatch-us-east-1', 'dynamodb-us-east-1', 'ec2-us-east-1', 'elb-us-east-1', 'emr-us-east-1', 'elastictranscoder-us-east-1', 'elasticache-us-east-1', 'fps', 'glacier-us-east-1', 'mturk-requestor', 'mturk-worker', 'redshift-us-east-1', 'rds-us-east-1', 'route53', 'ses-us-east-1', 'sns-us-east-1', 'sqs-us-east-1', 's3-us-standard', 'swf-us-east-1', 'simpledb-us-east-1', 'vpc-us-east-1', 'cloudformation-us-east-1', 'cloudhsm-us-east-1', 'datapipeline-us-east-1', 'directconnect-us-east-1', 'elasticbeanstalk-us-east-1', 'import-export', 'management-console', 'opsworks-us-east-1', 'storagegateway-us-east-1'];
    SERVICE_REGION['us-west-1'] = ['cloudfront', 'cloudsearch-us-west-1', 'cloudwatch-us-west-1', 'dynamodb-us-west-1', 'ec2-us-west-1', 'elb-us-west-1', 'emr-us-west-1', 'elastictranscoder-us-west-1', 'elasticache-us-west-1', 'fps', 'glacier-us-west-1', 'mturk-requestor', 'mturk-worker', 'rds-us-west-1', 'route53', 'sns-us-west-1', 'sqs-us-west-1', 's3-us-west-1', 's3-us-standard', 'swf-us-west-1', 'simpledb-us-west-1', 'vpc-us-west-1', 'cloudformation-us-west-1', 'directconnect-us-west-1', 'elasticbeanstalk-us-west-1', 'import-export', 'management-console', 'storagegateway-us-west-1'];
    SERVICE_REGION['us-west-2'] = ['cloudfront', 'cloudsearch-us-west-2', 'cloudwatch-us-west-2', 'dynamodb-us-west-2', 'ec2-us-west-2', 'elb-us-west-2', 'emr-us-west-2', 'elastictranscoder-us-west-2', 'elasticache-us-west-2', 'fps', 'glacier-us-west-2', 'mturk-requestor', 'mturk-worker', 'redshift-us-west-2', 'rds-us-west-2', 'route53', 'sns-us-west-2', 'sqs-us-west-2', 's3-us-west-2', 's3-us-standard', 'swf-us-west-2', 'simpledb-us-west-2', 'vpc-us-west-2', 'cloudformation-us-west-2', 'directconnect-us-east-1', 'elasticbeanstalk-us-west-2', 'import-export', 'management-console', 'storagegateway-us-west-2'];
    SERVICE_REGION['sa-east-1'] = ['cloudfront', 'cloudwatch-sa-east-1', 'dynamodb-sa-east-1', 'ec2-sa-east-1', 'elb-sa-east-1', 'emr-sa-east-1', 'elasticache-sa-east-1', 'rds-sa-east-1', 'route53', 'sns-sa-east-1', 'sqs-sa-east-1', 's3-sa-east-1', 'swf-sa-east-1', 'simpledb-sa-east-1', 'vpc-sa-east-1', 'cloudformation-sa-east-1', 'directconnect-sa-east-1', 'elasticbeanstalk-sa-east-1', 'management-console', 'storagegateway-sa-east-1'];
    SERVICE_REGION['eu-west-1'] = ['cloudfront', 'cloudsearch-eu-west-1', 'cloudwatch-eu-west-1', 'dynamodb-eu-west-1', 'ec2-eu-west-1', 'elb-eu-west-1', 'emr-eu-west-1', 'elastictranscoder-eu-west-1', 'elasticache-eu-west-1', 'glacier-eu-west-1', 'mturk-worker', 'redshift-eu-west-1', 'rds-eu-west-1', 'route53', 'sns-eu-west-1', 'sqs-eu-west-1', 's3-eu-west-1', 'swf-eu-west-1', 'simpledb-eu-west-1', 'vpc-eu-west-1', 'cloudformation-eu-west-1', 'cloudhsm-eu-west-1', 'directconnect-eu-west-1', 'elasticbeanstalk-eu-west-1', 'import-export', 'management-console', 'storagegateway-eu-west-1'];
    SERVICE_REGION['ap-southeast-1'] = ['cloudfront', 'cloudsearch-ap-southeast-1', 'cloudwatch-ap-southeast-1', 'dynamodb-ap-southeast-1', 'ec2-ap-southeast-1', 'elb-ap-southeast-1', 'emr-ap-southeast-1', 'elastictranscoder-ap-southeast-1', 'elasticache-ap-southeast-1', 'mturk-worker', 'rds-ap-southeast-1', 'route53', 'sns-ap-southeast-1', 'sqs-ap-southeast-1', 's3-ap-southeast-1', 'swf-ap-southeast-1', 'simpledb-ap-southeast-1', 'vpc-ap-southeast-1', 'cloudformation-ap-southeast-1', 'directconnect-ap-southeast-1', 'elasticbeanstalk-ap-southeast-1', 'import-export', 'management-console', 'storagegateway-ap-southeast-1'];
    SERVICE_REGION['ap-southeast-2'] = ['cloudfront', 'cloudwatch-ap-southeast-2', 'dynamodb-ap-southeast-2', 'ec2-ap-southeast-2', 'elb-ap-southeast-2', 'emr-ap-southeast-2', 'mturk-worker', 'rds-ap-southeast-2', 'route53', 'sns-ap-southeast-2', 'sqs-ap-southeast-2', 's3-ap-southeast-2', 'swf-ap-southeast-2', 'simpledb-ap-southeast-2', 'vpc-ap-southeast-2', 'cloudformation-ap-southeast-2', 'directconnect-ap-southeast-2', 'elasticbeanstalk-ap-southeast-2', 'import-export', 'management-console', 'storagegateway-ap-southeast-2'];
    SERVICE_REGION['ap-northeast-1'] = ['cloudfront', 'cloudwatch-ap-northeast-1', 'dynamodb-ap-northeast-1', 'ec2-ap-northeast-1', 'elb-ap-northeast-1', 'emr-ap-northeast-1', 'elastictranscoder-ap-northeast-1', 'elasticache-ap-northeast-1', 'glacier-ap-northeast-1', 'mturk-worker', 'redshift-ap-northeast-1', 'rds-ap-northeast-1', 'route53', 'sns-ap-northeast-1', 'sqs-ap-northeast-1', 's3-ap-northeast-1', 'swf-ap-northeast-1', 'simpledb-ap-northeast-1', 'vpc-ap-northeast-1', 'cloudformation-ap-northeast-1', 'directconnect-ap-northeast-1', 'elasticbeanstalk-ap-northeast-1', 'import-export', 'management-console', 'storagegateway-ap-northeast-1'];
    OPS_STATE = {
...
define("MC.canvas", ["MC","canvon"], function(){});
...
(function() {
  ...
  define('WS',['Meteor', 'underscore', "MC"], function(Meteor, _) {
    ...
    websocketInit = function() {
      ...
      Meteor._debug = function(message) {
    ...
    WebSocket = (function() {
      ...
      WebSocket.prototype.sub = function() {
        var args, error_callback, name, ready_callback, sub_instance, _i;
        name = arguments[0], args = 4 <= arguments.length ? __slice.call(arguments, 1, _i = arguments.length - 2) : (_i = 1, []), ready_callback = arguments[_i++], error_callback = arguments[_i++];
        sub_instance = Meteor.subscribe.apply(Meteor, [name].concat(__slice.call(args), [{
