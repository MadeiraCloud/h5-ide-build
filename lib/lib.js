...
function program3(depth0,data) {
  ...
  buffer += "\n        <div class=\"modal-footer\">\n            <button class=\"btn modal-confirm btn-"
    ...
    + "\" ";
  stack1 = helpers['if'].call(depth0, ((stack1 = (depth0 && depth0.confirm)),stack1 == null || stack1 === false ? stack1 : stack1.disabled), {hash:{},inverse:self.noop,fn:self.program(4, program4, data),data:data});
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += ">"
