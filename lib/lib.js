...
(function() {
  define('lib/handlebarhelpers',["i18n!/nls/lang.js", "handlebars"], function(lang) {
    ...
    Handlebars.registerHelper('readableVt', function(text) {
      ...
      return lang.IDE["PROP.VOLUME_TYPE_" + (text.toUpperCase())];
    });
    ...
    Handlebars.registerHelper('formatTime', function(timeStr, formatStr) {
...
(function() {
  define('constant',['MC', 'i18n!/nls/lang.js'], function(MC, lang) {
    var AWS_RESOURCE_KEY, AWS_RESOURCE_SHORT_TYPE, DB_DEFAULTSETTING, DB_ENGINE, DB_ENGINE_ARY, DB_ENGINTYPE, DB_INSTANCECLASS, DEMO_STACK_NAME_LIST, INSTANCE_STATES, LINUX, MESSAGE_E, OPS_CODE_NAME, OPS_STATE, OS_TYPE_MAPPING, REGEXP, REGION_KEYS, REGION_LABEL, REGION_SHORT_LABEL, RESNAME, RESTYPE, RETURN_CODE, STATE_REF_DICT, TA, WINDOWS, wrap;
    wrap = function(dict) {
      var wrappedDict;
      wrappedDict = {};
    ...
    REGION_KEYS = ['us-east-1', 'us-west-1', 'us-west-2', 'eu-west-1', 'ap-southeast-1', 'ap-southeast-2', 'ap-northeast-1', 'sa-east-1', 'eu-west-1', 'eu-central-1'];
    REGION_LABEL = {
