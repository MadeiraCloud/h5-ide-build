...
(function() {
  define('constant',['MC', 'i18n!nls/lang.js'], function(MC, lang) {
    var APP_STATE, AWS_PORT_NAME, AWS_RESOURCE, AWS_RESOURCE_KEY, AWS_RESOURCE_SHORT_TYPE, AWS_RESOURCE_TYPE, DEMO_STACK_NAME_LIST, INSTANCE_STATES, INSTANCE_TYPE, LINUX, MESSAGE_E, OPS_STATE, OS_TYPE, OS_TYPE_MAPPING, RDP_TMPL, RECENT_DAYS, RECENT_NUM, REGEXP, REGION_KEYS, REGION_LABEL, REGION_SHORT_LABEL, RESTYPE, RETURN_CODE, SERVICE_REGION, TA, WINDOWS;
    AWS_RESOURCE_KEY = {
