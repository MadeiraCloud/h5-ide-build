...
define('constant',['MC', 'i18n!/nls/lang.js'], function(MC, lang) {
  var AWS_RESOURCE_KEY, AWS_RESOURCE_SHORT_TYPE, DB_DEFAULTSETTING, DB_ENGINE, DB_ENGINE_ARY, DB_ENGINTYPE, DB_INSTANCECLASS, DEMO_STACK_NAME_LIST, INSTANCE_STATES, LINUX, MESOS_IMAGEID, MESSAGE_E, OPS_CODE_NAME, OPS_STATE, OS_TYPE_MAPPING, REGEXP, REGION_KEYS, REGION_LABEL, REGION_SHORT_LABEL, RESNAME, RESTYPE, RETURN_CODE, STATE_REF_DICT, TA, WINDOWS, wrap;
  wrap = function(dict) {
    var wrappedDict;
    wrappedDict = {};
