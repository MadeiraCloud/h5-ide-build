...
function program1(depth0,data) {
  ...
  var buffer = "", stack1;
  buffer += "<ul data-provider=\""
    + escapeExpression(((stack1 = (depth0 && depth0.id)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "\">";
  stack1 = helpers.each.call(depth0, (depth0 && depth0.regions), {hash:{},inverse:self.noop,fn:self.program(2, program2, data),data:data});
...
function program4(depth0,data) {
  ...
  var stack1;
  stack1 = helpers.each.call(depth0, (depth0 && depth0.regions), {hash:{},inverse:self.noop,fn:self.program(5, program5, data),data:data});
...
function program4(depth0,data) {
  ...
  return "<div class=\"no-avatar\">×</div>";
  }
...
function program6(depth0,data) {
  ...
  buffer += "<div class=\"dash-region-stacks-wrap\">\n    <label class=\"region-resource-tab clearfix\">\n        <span class=\"stack\">"
    ...
    + "</small></span>\n    </label>\n    <nav class=\"dash-region-navigation\" data-type=\"stacks\">\n        <button id=\"region-switch-stack\" class=\"js-toggle-dropdown\">\n            <i class=\"icon-caret-down right\"></i><span>"
    + escapeExpression(((stack1 = ((stack1 = (depth0 && depth0.currentRegion)),stack1 == null || stack1 === false ? stack1 : stack1.shortName)),typeof stack1 === functionType ? stack1.apply(depth0) : stack1))
    + "</span>\n        </button>\n\n        <ul id=\"region-switch-list\" class=\"dropdown-menu\">\n            <li data-region=\"global\">"
    + escapeExpression(helpers.i18n.call(depth0, "DASH_BTN_GLOBAL", {hash:{},data:data}))
    + "</li>\n            ";
  ...
  define('wspace/dashboard/DashboardView',["./DashboardTpl", "./ImportDialog", "./DashboardTplData", "constant", "./VisualizeDialog", "CloudResources", "AppAction", "UI.modalplus", "i18n!/nls/lang.js", "ide/submodels/ProjectLog", "credentialFormView", "UI.bubble", "backbone"], function(Template, ImportDialog, dataTemplate, constant, VisualizeDialog, CloudResources, AppAction, Modal, lang, ProjectLog, CredentialFormView) {
    ...
    return Backbone.View.extend({
      ...
      createStack: function(evt) {
        var $tgt, opsModel, provider, region;
        $tgt = $(evt.currentTarget);
        provider = $tgt.closest("ul").attr("data-provider");
        region = $tgt.attr("data-region");
        opsModel = this.model.scene.project.createStack(region, provider);
        this.model.scene.loadSpace(opsModel);
      },
