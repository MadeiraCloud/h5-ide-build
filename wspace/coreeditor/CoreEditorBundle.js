define('Design',["constant", "OpsModel", 'CloudResources'], function(constant, OpsModel, CloudResources) {
  ...
  Design = Backbone.Model.extend({
    ...
    initialize: function() {
      var canvas_data, component, layout, oldDesign;
      this.__componentMap = {};
      this.__classCache = {};
      this.__usedUidCache = {};
      this.__initializing = false;
      canvas_data = this.__opsModel.getJsonData();
      if (this.__opsModel.isStack()) {
      ...
      this.use();
      this.deserialize($.extend(true, {}, component), $.extend(true, {}, layout));
      if (oldDesign) {
        oldDesign.use();
      }
      return null;
    ...
    deserialize: function(json_data, layout_data) {
      ...
      Design.trigger(Design.EVENT.Deserialized, this);
      Backbone.Events.trigger.call(this, Design.EVENT.DidDeserialized);
      Design.trigger(Design.EVENT.DidDeserialized, this);
    ...
    project: function() {
      return this.__opsModel.project();
    },
    credential: function() {
      return this.__opsModel.credential();
    },
    ...
    serialize: function(options) {
      var attr, c, comp, component_data, connections, currentDesignObj, data, error, j, json, layout_data, mockArray, p1, p2, uid, visitor, _i, _j, _k, _len, _len1, _len2, _ref, _ref1;
      ...
      layout_data.size = this.attributes.canvasSize;
    ...
    EVENT: {
      ...
      DidDeserialized: "DIDDESERIALIZED"
    },
...
define('ResourceModel',["Design", 'CloudResources', "constant", "backbone"], function(Design, CloudResources, constant) {
  var ResourceModel, deepClone, __emptyObj;
  ...
  ResourceModel = Backbone.Model.extend({
    ...
    hasAppResource: function() {
      if (!Design.instance().modeIsStack() && this.get("appId")) {
        return !!this.get('appId') && CloudResources(this.design().credentialId(), this.type, this.design().region()).get(this.get('appId'));
      } else {
        return true;
      }
    },
...
define('wspace/coreeditor/TplOpsEditor',['handlebars'], function(Handlebars){ var __TEMPLATE__, TEMPLATE={"modal":{}};
...
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  ...
  buffer += "<div style=\"min-height:100px;\">\n  <div class=\"modal-text-major\">"
    ...
    + escapeExpression(helpers.i18n.call(depth0, "IDE.POP_LBL_CANCEL", {hash:{},data:data}))
    + "</button>\n</div>";
  return buffer;
  };
...
define('CoreEditorView',["wspace/coreeditor/TplOpsEditor", "UI.modalplus", "i18n!/nls/lang.js", "AppAction", "backbone", "UI.selectbox", "backbone", "UI.selectbox"], function(OpsEditorTpl, Modal, lang, AppAction) {
  ...
  return Backbone.View.extend({
    ...
    constructor: function(options) {
      ...
      this.setElement($(this.template()).appendTo(this.workspace.scene.spaceParentElement()).attr("data-ws", this.workspace.id).show()[0]);
    },
    ...
    showCloseConfirm: function() {
      ...
      modal.tpl.on("click", ".tar .confirm", function() {
        modal.close();
...
define('wspace/coreeditor/TplSvgDef',['handlebars'], function(Handlebars){ var TEMPLATE = function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
  var buffer = "", escapeExpression=this.escapeExpression;
...
define('CanvasElement',["Design", "CanvasManager", "i18n!/nls/lang.js", "UI.modalplus", "backbone", "svg"], function(Design, CanvasManager, lang, Modal) {
  var CanvasElement, CanvasView, SubElements;
  CanvasView = null;
  SubElements = {};
  CanvasElement = Backbone.View.extend({
    ...
    createGroup: function() {
      var el, height, m, pad, resizerHeight, resizerWidth, svg, width, x, y;
      m = this.model;
      x = m.x();
      y = m.y();
      ...
      svg = this.canvas.svg;
      el = svg.group();
      return el.add([svg.rect(width, height).radius(5).classes("group"), svg.rect(resizerWidth, pad).x(pad).classes("group-resizer top"), svg.rect(pad, resizerHeight).y(pad).classes("group-resizer left"), svg.rect(pad, resizerHeight).move(width - pad, pad).classes("group-resizer right"), svg.rect(resizerWidth, pad).move(pad, height - pad).classes("group-resizer bottom"), svg.rect(pad, pad).classes("group-resizer top-left"), svg.rect(pad, pad).x(width - pad).classes('group-resizer top-right'), svg.rect(pad, pad).y(height - pad).classes("group-resizer bottom-left"), svg.rect(pad, pad).move(width - pad, height - pad).classes("group-resizer bottom-right"), svg.text("").move(5, 15).classes("group-label")]).attr({
        "data-id": this.cid
...
define('CanvasView',["wspace/coreeditor/TplSvgDef", "CanvasElement", "CanvasManager", "Design", "i18n!/nls/lang.js", "UI.modalplus", "event", "backbone", "UI.nanoscroller", "svg"], function(SvgDefTpl, CanvasElement, CanvasManager, Design, lang, Modal, ide_event) {
  var CanvasView;
  ...
  CanvasView = Backbone.View.extend({
    ...
    initialize: function(options) {
      ...
      this.listenTo(this.design, Design.EVENT.DidDeserialized, this.reload);
    ...
    enlargeIfNeeded: function(width, height) {
      var size;
      size = this.size();
      if (size[0] < width) {
        this.resize("width", Math.ceil(width / 60) * 60 - size[0]);
      }
      if (size[1] < height) {
        this.resize("height", Math.ceil(height / 60) * 60 - size[1]);
      }
    },
    update: function() {
...
define('CanvasViewLayout',["CanvasView", "constant"], function(CanvasView, constant) {
  ...
  CanvasView.prototype.autoLayoutFully = function() {
     ...
     */
    this.enlargeIfNeeded(hierachy.width + 5, hierachy.height + 5);
  };
  return {
...
define('wspace/coreeditor/CeSvg',["CanvasElement", "constant", "CanvasManager", "i18n!/nls/lang.js", "UI.modalplus"], function(CanvasElement, constant, CanvasManager, lang, Modal) {
...
define('wspace/coreeditor/CanvasViewConnect',["CanvasView", "Design", "CanvasManager", "CanvasElement", "i18n!/nls/lang.js", "UI.modalplus"], function(CanvasView, Design, CanvasManager, CanvasElement, lang, Modal) {
...
define('wspace/coreeditor/CanvasViewDnd',["CanvasView", "CanvasElement", "CanvasManager", "constant", "i18n!/nls/lang.js"], function(CanvasView, CanvasElement, CanvasManager, constant, lang) {
...
define('wspace/coreeditor/CanvasViewGResizer',["CanvasView"], function(CanvasView) {
 ...
 */
define('wspace/coreeditor/EditorDeps',["Design", "ResourceModel", "ComplexResModel", "ConnectionModel", "GroupModel", "CoreEditor", "CoreEditorView", "CanvasManager", "CanvasView", "CanvasElement", "CanvasPopup", "CanvasViewLayout", "./CeSvg", "./CanvasViewConnect", "./CanvasViewDnd", "./CanvasViewGResizer", "./CanvasViewEffect", "./TplOpsEditor", "./TplSvgDef"], function(Design) {
 ...
 */
define('CoreEditor',["Workspace", "CoreEditorView", "wspace/coreeditor/TplOpsEditor", "ThumbnailUtil", "OpsModel", "Design", "ApiRequest", "UI.modalplus", "i18n!/nls/lang.js", "wspace/coreeditor/EditorDeps"], function(Workspace, CoreEditorView, OpsEditorTpl, Thumbnail, OpsModel, Design, ApiRequest, Modal, lang) {
  var LoadingView;
  LoadingView = Backbone.View.extend({
    isLoadingView: true,
    initialize: function(attr) {
      return this.setElement($(OpsEditorTpl.loading()).appendTo(attr.workspace.scene.spaceParentElement()).show()[0]);
    },
  ...
  return Workspace.extend({
    ...
    onOpsModelStateChanged: function() {
      if (this.opsModel.testState(OpsModel.State.Destroyed)) {
    ...
    jsonLoaded: function() {
      ...
      this.fetchData().then((function() {
        ...
        return self.dataLoadFailed();
      }));
    },
    dataLoadFailed: function() {
      if (this.isRemoved()) {
        return;
      }
    ...
    cleanup: function() {
      ...
      if (!this.opsModel.isPersisted() && !this.opsModel.testState(OpsModel.State.Saving)) {
    ...
    isRemovable: function() {
      if (!this.__inited || !this.isModified() || !this.opsModel.isPersisted()) {
        return true;
      }
    ...
    saveStack: function() {
      var newJson, self;
      newJson = this.design.serialize();
      self = this;
      return Thumbnail.generate(this.view.getSvgElement()).then(function(thumbnail) {
        return self.opsModel.save(newJson, thumbnail).fail(function(e) {
          if (e.error === ApiRequest.Errors.StackRepeatedStack) {
            e.msg = lang.NOTIFY.ERR_SAVE_FAILED_NAME;
          } else if (e.error === ApiRequest.Errors.StackConflict) {
...
define('CoreEditorViewApp',["CoreEditorView", "OpsModel", "wspace/coreeditor/TplOpsEditor", "UI.modalplus", "i18n!/nls/lang.js", "ApiRequest", "AppAction", "constant"], function(StackView, OpsModel, OpsEditorTpl, Modal, lang, ApiRequest, AppAction, constant) {
  return StackView.extend({
    ...
    confirmImport: function() {
      ...
      modal.on("confirm", function() {
        ...
        $ipt.parsley('custom', function(val) {
          ...
          apps = self.workspace.scene.project.apps().where({
            name: val
          });
    ...
    showUnpayUI: function() {
      ...
      new AppAction({
        workspace: this.workspace
      }).showPayment($("<div class='ops-apppm-wrapper'></div>", this.workspace.opsModel).appendTo(this.$el)[0]);
...
define('CoreEditorApp',["CoreEditor", "CoreEditorViewApp", "ResDiff", "OpsModel", "Design", "CloudResources", "constant", "ApiRequest", "i18n!/nls/lang.js", "wspace/coreeditor/EditorDeps"], function(StackEditor, AppView, ResDiff, OpsModel, Design, CloudResources, constant, ApiRequest, lang) {
  return StackEditor.extend({
    ...
    diff: function() {
      ...
      if (!this.opsModel.testState(OpsModel.State.Running) || this.scene.project.amIObserver()) {
        return;
      }
    ...
    applyDiff: function(newJson, autoLayout) {
      var e;
      try {
    ...
    loadVpcResource: function() {
      return CloudResources(this.opsModel.credentialId(), "OpsResource", this.opsModel.getMsrId()).init({
        region: this.opsModel.get("region"),
        provider: this.opsModel.get("provider"),
        project: this.scene.project.id
      }).fetchForce();
    },
    ...
    onOpsModelStateChanged: function() {
      ...
      if (this.isAppEditMode()) {
        ...
        if (this.opsModel.isProcessing()) {
          ...
          this.view.showUpdateStatus("", true);
          this.loadVpcResource().then((function(_this) {
            return function() {
              return _this.__onVpcResLoaded();
            };
          })(this));
        }
        return;
...
define("wspace/coreeditor/CoreEditorBundle", function(){});
