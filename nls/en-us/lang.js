define({
    ...
    "ide": {
        ...
        "TA_MSG_ERROR_STACK_HAVE_NOT_EXIST_SNAPSHOT": "Snapshot <span class='validation-tag tag-snapshot'>%s</span> attached to instance/launch configuration <span class='validation-tag tag-instance'>%s</span> is not available or not accessible to your account. Please change another one.",
