define({
    ...
    "ide": {
        ...
        "PORT_TIP_B": "Connect to Internet Gateway, VPN Gateway, instance or network interface to create route.",
        ...
        "PORT_TIP_I": "Connect to VPN Gateway to create VPN",
        "PORT_TIP_J": "Connect to instance or launch configuration to register behind load balancer",
        "PORT_TIP_K": "Connect a subnet for each Availability Zone",
        "PORT_TIP_L": "Connect to associate with load balancer",
        "PORT_TIP_M": "Connect to associate with route table",
