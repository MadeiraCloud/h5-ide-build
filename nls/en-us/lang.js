define({
    ...
    "ide": {
        ...
        "PROP_AGENT_USER_DATA_URL": "https://github.com/VisualOps/OpsAgent/blob/develop/scripts/userdata.sh",
        ...
        "TA_MSG_ERROR_INSTANCE_REF_OLD_KEYPAIR": "%s has associated with an nonexistient key pair <span class='validation-tag'>%s</span>. Make sure to use an existing key pair or creating a new one.",
        ...
        "TA_MSG_ERROR_ASG_NOTIFICITION_TOPIC_NONEXISTIENT": "Auto Scaling Group <span class='validation-tag tag-asg'>%s</span> is using a nonexistient SNS Topic <span class='validation-tag'>%s</span>. Please change to an existing SNS Topic to make notification work.",
        "TA_MSG_ERROR_ASG_POLICY_TOPIC_NONEXISTIENT": "Auto Scaling Group <span class='validation-tag tag-asg'>%s</span>'s Scaling Policy %s is using a nonexistent SNS Topic <span class='validation-tag'>%s</span>. Please change to an existing SNS Topic to make notification work.",
