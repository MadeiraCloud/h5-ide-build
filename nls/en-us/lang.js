define({
    ...
    "ide": {
        ...
        "CVS_CFM_DEL_NONEXISTENT_DBINSTANCE": "%s hasn't existed, delete it will also remove all read replica to related it. Are you sure to delete?",
        "CVS_CFM_DEL_EXISTENT_DBINSTANCE": "%s has existed, delete it will remove read replica to related it, but keep existed replica. Are you sure to delete?",
