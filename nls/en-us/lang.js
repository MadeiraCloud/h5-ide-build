define({
    ...
    "ide": {
        ...
        "TOOL_TOGGLE_VISUALOPS_OFF": "instnace state off",
        ...
        "SETTINGS_CRED_DEMO_TEXT": "Some stack you build in demo mode may report error due to resource inconsistency between different accounts.",
        ...
        "SETTINGS_CRED_UPDATE_CONFIRM_TIT": "You have un-terminated app. Do you confirm to update the AWS credential?",
        ...
        "WELCOME_SKIP_MSG": "- The demo mode may not reflect the real condition of resources available for your account.<br /> - If you want to provide credentials later, design previously created in demo mode may not work due to resource inconsistency.",
