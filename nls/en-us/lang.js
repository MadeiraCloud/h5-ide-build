define({
    ...
    "ide": {
        "PARSLEY_MUST_BE_A_VALID_FORMAT_OF_NUMBER": "Must be a valid format of number.",
        "PARSLEY_THE_PROTOCOL_NUMBER_RANGE_MUST_BE_0_255": "The protocol number range must be 0-255.",
        "PARSLEY_MUST_BE_A_VALID_FORMAT_OF_PORT_RANGE": "Must be a valid format of port range.",
        "PARSLEY_PORT_RANGE_BETWEEN_0_65535": "Port range needs to be a number or a range of numbers between 0 and 65535.",
        "PARSLEY_VALID_RULE_NUMBER_1_TO_32767": "Valid rule number must be between 1 to 32767.",
        "PARSLEY_RULE_NUMBER_100_HAS_EXISTED": "The DefaultACL's Rule Number 100 has existed.",
        "PARSLEY_RULENUMBER_ALREADY_EXISTS": "Rule %s already exists.",
        "PARSLEY_MUST_BE_CIDR_BLOCK": "Must be a valid form of CIDR block.",
        "PARSLEY_MAX_VALUE_86400": "Max value: 86400",
        "PARSLEY_DUPLICATED_POLICY_NAME": "Duplicated policy name in this autoscaling group",
        "PARSLEY_ASG_SIZE_MUST_BE_EQUAL_OR_GREATER_THAN_1": "ASG size must be equal or greater than 1",
        "PARSLEY_MINIMUM_SIZE_MUST_BE_LESSTHAN_MAXIMUM_SIZE": "Minimum Size must be <= Maximum Size.",
        "PARSLEY_MAXIMUM_SIZE_MUST_BE_MORETHAN_MINIMUM_SIZE": "Maximum Size must be >= Minimum Size.",
        "PARSLEY_VALUE_MUST_BE_LESSTHAN_VAR": "This value should be < %s",
        "PARSLEY_VALUE_MUST_BE_GREATERTHAN_VAR": "This value should be > %s",
        "PARSLEY_VALUE_MUST_IN_ALLOW_SCOPE": "This value should be >= %s and <= %s",
        "PARSLEY_DESIRED_CAPACITY_EQUAL_OR_GREATER_1": "Desired Capacity must be equal or greater than 1",
        "PARSLEY_DESIRED_CAPACITY_IN_ALLOW_SCOPE": "Desired Capacity must be >= Minimal Size and <= Maximum Size",
        "PARSLEY_THIS_VALUE_SHOULD_BE_A_VALID_TYPE_NAME": "This value should be a valid %s name.",
        "PARSLEY_TYPE_NAME_CONFLICT": "%s name \" %s \" is already in using. Please use another one.",
        "PARSLEY_RESOURCE_NAME_ELBSG_RESERVED": "Resource name starting with \"elbsg-\" is reserved.",
        "PARSLEY_MUST_BE_BETWEEN_1_AND_65534": "Must be between 1 and 65534",
        "PARSLEY_ASN_NUMBER_7224_RESERVED": "ASN number 7224 is reserved in Virginia",
        "PARSLEY_ASN_NUMBER_9059_RESERVED_IN_IRELAND": "ASN number 9059 is reserved in Ireland",
        "PARSLEY_LOAD_BALANCER_PORT_MUST_BE_SOME_PROT": "Load Balancer Port must be either 25,80,443 or 1024 to 65535 inclusive",
        "PARSLEY_INSTANCE_PORT_MUST_BE_BETWEEN_1_AND_65535": "Instance Port must be between 1 and 65535",
        "PARSLEY_THIS_NAME_IS_ALREADY_IN_USING": "This name is already in using.",
        "PARSLEY_INVALID_IP_ADDRESS": "Invalid IP address",
        "PARSLEY_VOLUME_SIZE_OF_ROOTDEVICE_MUST_IN_RANGE": "Volume size of this rootDevice must in the range of %s -1024 GB.",
        "PARSLEY_IOPS_MUST_BETWEEN_100_4000": "IOPS must be between 100 and 4000",
        "PARSLEY_IOPS_MUST_BE_LESS_THAN_10_TIMES_OF_VOLUME_SIZE": "IOPS must be less than 10 times of volume size.",
        "PARSLEY_THIS_VALUE_MUST_BETWEEN_1_99": "This value must be >= 1 and <= 99",
        "PARSLEY_SHOULD_BE_A_VALID_STACK_NAME": "This value should be a valid Stack name",
        "PARSLEY_PLEASE_PROVIDE_A_VALID_AMAZON_SQS_ARN": "Please provide a valid Amazon SQS ARN",
        "PARSLEY_PLEASE_PROVIDE_A_VALID_APPLICATION_ARN": "Please provide a valid Application ARN",
        "PARSLEY_PLEASE_PROVIDE_A_VALID_PHONE_NUMBER": "Please provide a valid phone number (currently only support US phone number)",
        "PARSLEY_PLEASE_PROVIDE_A_VALID_URL": "Please provide a valid URL",
        "PARSLEY_VOLUME_SIZE_MUST_IN_1_1024": "Volume size must in the range of 1-1024 GB.",
        "PARSLEY_DEVICENAME_LINUX": "Device name must be like /dev/hd[a-z], /dev/hd[a-z][1-15],/dev/sd[a-z] or /dev/sd[b-z][1-15]",
        "PARSLEY_DEVICENAME_WINDOWS": "Device name must be like xvd[f-p].",
        "PARSLEY_VOLUME_NAME_INUSE": "Volume name '%s' is already in using. Please use another one.",
        ...
        "CVS_MSG_ERR_SERVERGROUP_VOLUME": "Detach existing volume or snapshot of instance server group is not supported yet.",
        "CVS_MSG_ERR_SERVERGROUP_VOLUME2": "Attach existing volume from single instance to instance server group is not supported yet.",
        ...
        "CVS_MSG_WARN_NOTMATCH_SGP_VPC": "Subnet Group must be dragged to a vpc.",
        "CVS_MSG_WARN_NOTMATCH_DBINSTANCE_SGP": "DB Instance must be dragged to a subnet group.",
        "CVS_MSG_WARN_NOTMATCH_ASG": "Auto Scaling Group must be dropped in a subnet.",
        ...
        "CVS_MSG_WARN_NOTMATCH_IGW": "Internet gateways must be dragged inside a VPC.",
        "CVS_MSG_WARN_NOTMATCH_VGW": "Virtual private gateways must be dragged inside a VPC.",
        "CVS_MSG_WARN_COMPONENT_OVERLAP": "Nodes cannot overlap each other.",
        "CVS_MSG_WARN_NO_ENOUGH_SPACE": "No enough space.",
        "CVS_WARN_EXCEED_ENI_LIMIT": "%s's type %s supports a maximum of %s network interfaces (including the primary).",
        "CVS_MSG_WARN_CANNOT_CONNECT_SUBNET_TO_ELB": "This subnet cannot be attached with a Load Balancer. Its CIDR mask must be smaller than /27",
        ...
        "TOOL_POP_BODY_DELETE_STACK": "Do you confirm to delete stack '%s'?",
        "TOOL_POP_BTN_DELETE_STACK": "Delete",
        "TOOL_POP_BTN_CANCEL": "Cancel",
        "TOOL_POP_EXPORT_CF": "Export to AWS CloudFormation Template",
        "TOOL_POP_EXPORT_CF_INFO": "Download the template file when it's ready, then you can upload it in AWS console to create CloudFormation Stack.",
        "TOOL_POP_BTN_EXPORT_CF": "Download Template File",
        "TOOL_TIP_DUPLICATE_STACK": "Duplicate Stack",
        "TOOL_TIT_CLOSE_TAB": "Close Tab",
        "TOOL_POP_TIT_DUPLICATE_STACK": "Duplicate Stack",
        "TOOL_POP_BODY_DUPLICATE_STACK": "New Stack Name:",
        "TOOL_POP_BODY_APP_To_STACK": "New Stack Name:",
        ...
        "TOOL_POP_TIT_STOP_PRD_APP": "Confirm to Stop App for Production",
        "TOOL_POP_BTN_STOP_APP": "Stop",
        "TOOL_TIP_START_APP": "Start App",
        "TOOL_POP_TIT_START_APP": "Confirm to Start App",
        "TOOL_POP_BODY_START_APP": "Do you confirm that you would like to start the app?",
        "TOOL_POP_BTN_START_APP": "Start",
        "TOOL_TIP_UPDATE_APP": "Edit App",
        "TOOL_TIP_SAVE_UPDATE_APP": "Apply Updates",
        "TOOL_TIP_CANCEL_UPDATE_APP": "Discard Updates",
        "TOOL_TIP_TERMINATE_APP": "Permanently Terminate This App's Resources",
        "TOOL_POP_TIT_TERMINATE_APP": "Confirm to Terminate App",
        "TOOL_POP_BODY_TERMINATE_APP_LEFT": "Warning: all resources in the app will be permanantly deleted. <br/>Do you confirm to terminate app",
        "TOOL_POP_BODY_TERMINATE_APP_RIGHT": "?",
        "TOOL_POP_BTN_TERMINATE_APP": "Terminate",
        "TOOL_POP_TIT_TERMINATE_PRD_APP": "Confirm to Terminate App for Production",
        ...
        "TOOL_MSG_ERR_SAVE_FAILED_NAME": "The name of the stack has already been used, please change to a new one.",
        ...
        "TOOL_POP_BODY_APP_UPDATE_EC2": "The public and private addresses will be reassigned after the restart.",
        "TOOL_POP_BODY_APP_UPDATE_VPC": "If any of the instance(s) has been automatically assigned public IP, the IP will change after restart.",
        "TOOL_MSG_ERR_CONVERT_CLOUDFORMATION": "Convert to stack json to CloudFormation format error",
        "TOOL_TIP_REFRESH_REOURCES": "Refresh Reources",
        "TOOL_TIP_JSON_DIFF": "JSON Diff",
        "TOOL_TIP_JSON_VIEW": "JSON View",
        "TOOL_TIP_CUSTOM_USER_DATA": "Custom User Data will be overridden and disabled to allow installing OpsAgent. (Currently only support Linux platform)",
        "TOOL_TIP_NO_CLASSIC_DATA_STACK": "We will drop support for EC2 Classic and Default VPC soon. We have disabled create new stack, run app or edit app in those platforms. You can export existing stacks as CloudFormation template or as a PNG file. Click to read detailed announcement.",
        "TOOL_TIP_NO_CLASSIC_DATA_APP": "We will drop support for EC2 Classic and Default VPC soon. We have disabled create new stack, run app or edit app in those platforms. You can still manage the lifecycle of existing apps.  Click to read detailed announcement.",
        "TOOL_TIP_LINESTYLE": "Line Style",
        "TOOL_LBL_LINESTYLE_STRAIGHT": "Straight",
        "TOOL_LBL_LINESTYLE_ELBOW": "Elbow",
        "TOOL_LBL_LINESTYLE_CURVE": "Curve",
        "TOOL_LBL_LINESTYLE_SMOOTH_QUADRATIC_BELZIER": "Smooth quadratic Belzier curve",
        "TOOL_LBL_LINESTYLE_HIDE_SG": "Hide SecurityGroup line",
        "TOOL_LBL_LINESTYLE_SHOW_SG": "Show SecurityGroup line",
        "TOOL_EXPERIMENT": "Experimental Feature!",
        "TOOL_TOGGLE_VISUALOPS_ON": "instance state on",
        "TOOL_TOGGLE_VISUALOPS_OFF": "instance state off",
        "TOOL_LBL_NO_CLASSIC": "Where are the missing buttons?",
        "TOOL_EDIT_APP": "Edit App",
        "TOOL_APPLY_EDIT": "Apply",
        "TOOL_START_APP": "Start App",
        ...
        "PROP_INSTANCE_TENANCY_DELICATED": "Dedicated",
        "PROP_INSTANCE_ROOT_DEVICE_TYPE": "Block Device Type",
        "PROP_INSTANCE_BLOCK_DEVICE": "Block Devices",
        "PROP_INSTANCE_DEFAULT_KP": "$DefaultKeyPair",
        "PROP_INSTANCE_NO_KP": "No Key Pair",
        "PROP_INSTANCE_NEW_KP": "Create New Key Pair",
        "PROP_INSTANCE_FILTER_KP": "Filter by key pair name",
        "PROP_INSTANCE_MANAGE_KP": "Manage Region Key Pairs ...",
        "PROP_INSTANCE_FILTER_SNS": "Filter by SNS Topic name",
        "PROP_INSTANCE_MANAGE_SNS": "Manage SNS Topic ...",
        "PROP_INSTANCE_FILTER_SSL_CERT": "Filter by SSL Certificate name",
        "PROP_INSTANCE_MANAGE_SSL_CERT": "Manage SSL Certificate...",
        "PROP_INSTANCE_TIP_DEFAULT_KP": "If you have used $DefaultKeyPair for any instance/launch configuration, you will be required to specify an existing key pair for $DefaultKeyPair. Or you can choose \"No Key Pair\" as $DefaultKeyPair.",
        "PROP_INSTANCE_TIP_NO_KP": "If you select no key pair, you will not be able to connect to the instance unless you already know the password built into this AMI.",
        ...
        "PROP_INSTANCE_USER_DATA_DISABLE": "Can't edit user data when instance state exist",
        ...
        "PROP_AGENT_USER_DATA_URL": "https://github.com/MadeiraCloud/OpsAgent/blob/develop/scripts/userdata.sh",
        ...
        "PROP_AMI_STACK_NOT_AVAILABLE": "<p>This AMI is not available. It may have been deleted by its owner or not shared with your AWS account. </p><p>Please change to another AMI.</p>",
        "PROP_AMI_APP_NOT_AVAILABLE": "This AMI's infomation is unavailable.",
        "PROP_STACK_AMAZON_ARN": "Amazon ARN",
        "PROP_STACK_EXAMPLE_EMAIL": "example@acme.com",
        "PROP_STACK_E_G_1_206_555_6423": "e.g. 1-206-555-6423",
        "PROP_STACK_HTTP_WWW_EXAMPLE_COM": "http://www.example.com",
        "PROP_STACK_HTTPS_WWW_EXAMPLE_COM": "https://www.example.com",
        "PROP_STACK_HTTPS": "https",
        "PROP_STACK_HTTP": "http",
        "PROP_STACK_USPHONE": "usPhone",
        "PROP_STACK_EMAIL": "email",
        "PROP_STACK_ARN": "arn",
        "PROP_STACK_SQS": "sqs",
        "PROP_STACK_PENDING_CONFIRM": "pendingConfirm",
        "PROP_STACK_LBL_NAME": "Stack Name",
        "PROP_APP_LBL_NAME": "App Name",
        ...
        "PROP_APP_LBL_INSTANCE_STATE": "Instance State",
        "PROP_APP_LBL_RESDIFF": "Monitor and report external resource change of this app",
        "PROP_APP_LBL_RESDIFF_VIEW": "Monitor and Report External Change",
        ...
        "PROP_APP_SNS_NONE": "This app has no SNS Subscription",
        ...
        "PROP_VPC_DHCP_LBL_NONE": "Default",
        "PROP_VPC_DHCP_LBL_DEFAULT": "Auto-assigned Set",
        ...
        "PROP_VPC_MANAGE_DHCP": "Manage DHCP Options Set",
        "PROP_VPC_MANAGE_RDS_PG": "Manage Parameter Group",
        "PROP_VPC_FILTER_RDS_PG": "Filter by Parameter Group Name",
        "PROP_VPC_FILTER_DHCP": "Filter by DHCP Options Set ID",
        "PROP_VPC_TIP_AUTO_DHCP": "A DHCP Options set will be automatically assigned for the VPC by AWS.",
        "PROP_VPC_TIP_DEFAULT_DHCP": "The VPC will use no DHCP options.",
        "PROP_VPC_AUTO_DHCP": "Auto-assigned Set",
        "PROP_VPC_DEFAULT_DHCP": "Default",
        "PROP_SUBNET_TIP_CIDR_BLOCK": "e.g. 10.0.0.0/24. The range of IP addresses in the subnet must be a subset of the IP address in the VPC. Block sizes must be between a /16 netmask and /28 netmask. The size of the subnet can equal the size of the VPC.",
        ...
        "PROP_VPC_TIP_EG_10_0_0_0_16": "e.g. 10.0.0.0/16",
        "PROP_VPC_TIP_ENTER_THE_DOMAIN_NAME": "Enter the domain name that should be used for your hosts",
        "PROP_VPC_TIP_ENTER_UP_TO_4_DNS": "Enter up to 4 DNS server IP addresses",
        "PROP_VPC_TIP_ENTER_UP_TO_4_NTP": "Enter up to 4 NTP server IP addresses",
        "PROP_VPC_TIP_ENTER_UP_TO_4_NETBIOS": "Enter up to 4 NetBIOS server IP addresses",
        "PROP_VPC_TIP_EG_172_16_16_16": "e.g. 172.16.16.16",
        "PROP_VPC_TIP_SELECT_NETBIOS_NODE": "Select NetBIOS Node Type. We recommend 2. (Broadcast and multicast are currently not supported by AWS.)",
        "PROP_VPC_TIP_": "",
        ...
        "PROP_SG_APP_SG_NAME": "Security Group Name",
        ...
        "PROP_VPN_TIP_EG_192_168_0_0_16": "e.g., 192.168.0.0/16",
        ...
        "PROP_CGW_APP_VPN_LBL_STATUS_RT": "Static Routes",
        ...
        "PROP_CGW_TIP_THIS_ADDRESS_MUST_BE_STATIC": "This address must be static and not behind a NAT. e.g. 12.1.2.3",
        "PROP_CGW_TIP_1TO65534": "1 - 65534",
        ...
        "PROP_MSG_WARN_FAILA_TO_RUN_BECAUSE": "Failed to run your stack %s because of %s",
        ...
        "PROP_WARN_SG_RULE_EXIST": "The adding rule already exist.",
        ...
        "PROP_VOLUME_SNAPSHOT_SELECT": "Select volume from which to create snapshot",
        "PROP_VOLUME_SNAPSHOT_SELECT_REGION": "Select Destination Region",
        ...
        "PROP_VOLUME_ENCRYPTED": "Encrypted",
        "PROP_VOLUME_TYPE_STANDARD": "Magnetic",
        "PROP_VOLUME_TYPE_GP2": "General Purpose (SSD)",
        "PROP_VOLUME_TYPE_IO1": "Provisioned IOPS (SSD)",
        "PROP_VOLUME_MSG_WARN": "Volume size must be at least 10 GB to use Provisioned IOPS volume type.",
        "PROP_VOLUME_ENCRYPTED_LABEL": "Encrypt this volume",
        ...
        "PROP_ENI_TIP_ADD_IP_ADDRESS": "Add IP Address",
        ...
        "PROP_ELB_BTN_ADD_SERVER_CERTIFICATE": "Add SSL Certificate",
        "PROP_ELB_SERVER_CERTIFICATE": "SSL Certificate",
        "PROP_ELB_LBL_LISTENER_NAME": "Name",
        "PROP_ELB_LBL_LISTENER_DESCRIPTIONS": "Listener Descriptions",
        "PROP_ELB_LBL_LISTENER_CERT_NAME": "Certificate Name",
        ...
        "PROP_ELB_CROSS_ZONE": "Cross-zone Load Balancing",
        "PROP_ELB_CONNECTION_DRAIN": "Connection Draining",
        ...
        "PROP_ELB_TIP_25_80_443OR1024TO65535": "25, 80, 443 or 1024 - 65535",
        "PROP_ELB_TIP_1_65535": "1 - 65535",
        "PROP_ELB_TIP_CLICK_TO_READ_RELATED_AWS_DOCUMENT": "Click to read related AWS document",
        "PROP_ELB_CERT_REMOVE_CONFIRM_TITLE": "Confirm to Delete SSL Certificate",
        "PROP_ELB_CERT_REMOVE_CONFIRM_MAIN": "Do you confirm to delete ",
        "PROP_ELB_CERT_REMOVE_CONFIRM_SUB": "Load Balancer currently using this server certificate will have errors.",
        "PROP_ASG_SUMMARY": "Auto Scaling Group Summary",
        ...
        "PROPERTY_ASG_ELB_WARN": "If the calls to Elastic Load Balancing health check for the instance returns any state other than InService, Auto Scaling marks the instance as Unhealthy. And if the instance is marked as Unhealthy, Auto Scaling starts the termination process for the instance.",
        ...
        "PROP_ASG_LBL_SEND_NOTIFICATION_D": "Send notification via SNS topic",
        ...
        "PROP_ASG_ADD_POLICY_SECONDS": "minutes, enter ALARM state.",
        ...
        "PROP_ASG_TIP_CLICK_TO_SELECT": "Click to select",
        "PROP_ASG_TIP_YOU_CAN_ONLY_ADD_25_SCALING_POLICIES": "You can only add 25 scaling policies",
        ...
        "PROP_RT_TIP_ACTIVE": "Active",
        "PROP_RT_TIP_BLACKHOLE": "Blackhole",
        "PROP_RT_TIP_PROPAGATED": "Propagated",
        ...
        "PROP_SNAPSHOT_SET_NAME": "Snapshot Name",
        "PROP_SNAPSHOT_SET_NAME_TIP": "Enter the name of the snapshot that you will create.",
        "PROP_SNAPSHOT_SOURCE_SNAPSHOT": "Source Snapshot",
        "PROP_SNAPSHOT_SET_NEW_NAME": "New Snapshot Name",
        "PROP_SNAPSHOT_DESTINATION_REGION": "Destination Region",
        "PROP_SNAPSHOT_SET_VOLUME": "Volume",
        "PROP_SNAPSHOT_SET_INSTANCE": "Instance",
        "PROP_INSTANCE_SNAPSHOT_SELECT": "Select DB instance from which to create snapshot",
        "PROP_SNAPSHOT_SET_DESC": "Description",
        "PROP_VPC_TIP_ENTER_THE_NEW_SNAPSHOT_NAME": "Please fill with the name of the new snapshot you will create.",
        "PROP_SNAPSHOT_SET_DESC_TIP": "Fill in the Description",
        "PROP_DBPG_RESMANAGER_FILTER": "Filter DB Engine by family name",
        "PROP_DBPG_SET_FAMILY": "Family",
        "PROP_DBPG_SET_NAME": "Parameter Group Name",
        "PROP_DBPG_SET_DESC": "Description",
        "PROP_DBINSTANCE_TIT_DETAIL": "DB Instance Detail",
        "PROP_DBINSTANCE_APP_DBINSTANCE_ID": "DB Instance Identifier",
        "PROP_DBINSTANCE_ENDPOINT": "Endpoint",
        "PROP_DBINSTANCE_STATUS": "Status",
        "PROP_DBINSTANCE_ENGINE": "Engine",
        "PROP_DBINSTANCE_AUTO_UPGRADE": "Auto Minor Version Upgrade",
        ...
        "PROP_DBINSTANCE_DBCONFIG": "Database Config",
        "PROP_DBINSTANCE_NAME": "Database Name",
        "PROP_DBINSTANCE_PORT": "Database Port",
        "PROP_DBINSTANCE_OG": "Option Group",
        "PROP_DBINSTANCE_PG": "Parameter Group",
        "PROP_DBINSTANCE_NETWORK_AVAILABILITY": "Network & Availability",
        "PROP_DBINSTANCE_SUBNETGROUP": "Subnet Group",
        "PROP_DBINSTANCE_PREFERRED_ZONE": "Preferred Availability Zone",
        "PROP_DBINSTANCE_SECONDARY_ZONE": "Secondary Availability Zone",
        "PROP_DBINSTANCE_PUBLIC_ACCESS": "Publicly Accessible",
        "PROP_DBINSTANCE_LICENSE_MODEL": "License Model",
        "PROP_DBINSTANCE_BACKUP_MAINTENANCE": "Backup & Maintenance",
        "PROP_DBINSTANCE_AUTOBACKUP": "Automated Backups",
        "PROP_DBINSTANCE_LAST_RESTORE": "Lastest Restore Time",
        "PROP_DBINSTANCE_BACKUP_WINDOW": "Backup Window",
        "PROP_DBINSTANCE_MAINTENANCE_WINDOW": "Maintenance Window",
        "PROP_DBINSTANCE_SECURITY_GROUP": "Security Group",
        "PROP_DBINSTANCE_SUBNET_GROUP_NAME": "DB Subnet Group Name",
        "PROP_DBINSTANCE_SUBNET_GROUP_DESC": "DB Subnet Group Description",
        "PROP_DBINSTANCE_SUBNET_GROUP_STATUS": "Status",
        "PROP_DBINSTANCE_SUBNET_GROUP_MEMBERS": "Members",
        ...
        "NOTIFY_MSG_WARN_AUTH_FAILED": "Authentication failed.",
        "NOTIFY_MSG_INFO_STATE_COPY_TO_CLIPBOARD": "State(s) copied to clipboard",
        ...
        "NOTIFY_MSG_WARN_CANNT_AUTO_ASSIGN_CIDR_FOR_SUBNET": "Cannot auto-assign cidr for subnets, please manually update subnets' cidr before changing vpc's cidr.",
        "NOTIFY_MSG_WARN_VPC_DOES_NOT_EXIST": "VPC does not exist.",
        ...
        "TA_MSG_WARNING_NOT_VPC_CAN_CONNECT_OUTSIDE": "No instance in VPC has Elastic IP or auto-assigned public IP, which means this VPC can only connect to outside via VPN.",
        "TA_MSG_ERROR_CIDR_ERROR_CONNECT_TO_ELB": "Subnet <span class='validation-tag tag-subnet'>%s</span> is attached with a Load Balancer. Its mask must be smaller than /27.",
        "TA_MSG_NOTICE_INSTANCE_NOT_EBS_OPTIMIZED_FOR_ATTACHED_PROVISIONED_VOLUME": "Instance <span class='validation-tag tag-instance'>%s</span> has an attached Provisioned IOPS volume but is not EBS-Optimized.",
        "TA_MSG_WARNING_INSTANCE_SG_RULE_EXCEED_FIT_NUM": "Instance <span class='validation-tag tag-instance'>%s</span> has more than %s security group rules, If a Instance has a large number of security group rules, performance can be degraded.",
        "TA_MSG_ERROR_INSTANCE_NAT_CHECKED_SOURCE_DEST": "To allow routing to work properly, instance <span class='validation-tag tag-instance'>%s</span> should disabled Source/Destination Checking in \"Network Interface Details\"",
        "TA_MSG_ERROR_INSTANCE_REF_OLD_KEYPAIR": "%s has associated with an nonexistent key pair <span class='validation-tag'>%s</span>. Make sure to use an existing key pair or creating a new one.",
        ...
        "TA_MSG_ERROR_ELB_HAVE_REPEAT_LISTENER_ITEM": "Load Balancer <span class='validation-tag tag-elb'>%s</span> has duplicate load balancer ports.",
        "TA_MSG_ERROR_ELB_HAVE_NO_SSL_CERT": "Load Balancer <span class='validation-tag tag-elb'>%s</span> is using HTTPS/SSL protocol for Load Balancer Listener. Please add server certificate.",
        "TA_MSG_ERROR_ELB_RULE_NOT_INBOUND_TO_ELB_LISTENER": "Load balancer <span class='validation-tag tag-elb'>%s</span> should allow inbound traffic towards its Load Balancer Protocol: %s.",
        ...
        "TA_MSG_ERROR_ELB_SSL_CERT_NOT_EXIST_FROM_AWS": "Load Balancer <span class='validation-tag tag-elb'>%s</span>'s Listener is configured with nonexistent Server Certificate <span class='validation-tag tag-cert'>%s</span>.",
        ...
        "TA_MSG_WARNING_SG_RULE_FULL_ZERO_SOURCE_TARGET_TO_OTHER_PORT": "Security Group <span class='validation-tag tag-sg'>%s</span> has inbound rule which traffic from <span class='validation-tag tag-ip'>0.0.0.0/0</span> is not targeting port <span class='validation-tag tag-port'>80</span> or <span class='validation-tag tag-port'>443</span>.",
        "TA_MSG_NOTICE_SG_RULE_USING_PORT_22": "Security Group <span class='validation-tag tag-sg'>%s</span> has rule which using port <span class='validation-tag tag-port'>22</span>. To enhance security, suggest to use other port than <span class='validation-tag tag-port'>22</span>.",
        "TA_MSG_WARNING_SG_RULE_HAVE_FULL_ZERO_OUTBOUND": "Security Group <span class='validation-tag tag-sg'>%s</span> has outbound rule towards <span class='validation-tag tag-ip'>0.0.0.0/0</span>. Suggest to change to more specific range.",
        "TA_MSG_ERROR_RESOURCE_ASSOCIATED_SG_EXCEED_LIMIT": "%s <span class='validation-tag tag-%s'>%s</span>'s associated Security Group exceed max %s limit.",
        "TA_MSG_ERROR_ASG_HAS_NO_LAUNCH_CONFIG": "Auto Scaling Group <span class='validation-tag tag-asg'>%s</span> has no launch configuration.",
        "TA_MSG_WARNING_ELB_HEALTH_NOT_CHECK": "Auto Scaling Group <span class='validation-tag tag-asg'>%s</span> has connected to Load Balancer but the Load Balancer health check is not enabled.",
        "TA_MSG_ERROR_HAS_EIP_NOT_HAS_IGW": "VPC has instance with Elastic IP must have an Internet Gateway.",
        "TA_MSG_NOTICE_RT_ROUTE_NAT": "Instance <span class='validation-tag tag-instance'>%s</span> is a target of Route Table <span class='validation-tag tag-rtb'>%s</span>. To make sure the routing works, <span class='validation-tag tag-instance'>%s</span> should have security group rule to allow traffic from subnets assciated with <span class='validation-tag tag-rtb'>%s</span>.",
        "TA_MSG_NOTICE_INSTANCE_HAS_RTB_NO_ELB": "Route Table <span class='validation-tag tag-rtb'>%s</span> has route to Instance <span class='validation-tag tag-instance'>%s</span>. If <span class='validation-tag tag-instance'>%s</span> is working as NAT instance, it should be assigned with an Elastic IP.",
        "TA_MSG_WARNING_NO_RTB_CONNECT_IGW": "No Route Table is connected to Internet Gateway.",
        "TA_MSG_WARNING_NO_RTB_CONNECT_VGW": "No Route Table is connected to VPN Gateway.",
        "TA_MSG_NOTICE_ACL_HAS_NO_ALLOW_RULE": "Network ACL <span class='validation-tag tag-acl'>%s</span> has no ALLOW rule. The subnet(s) associate(s) with it cannot have traffic in or out.",
        "TA_MSG_ERROR_RT_HAVE_CONFLICT_DESTINATION": "Route Table <span class='validation-tag tag-rtb'>%s</span> has routes with conflicting CIDR blocks.",
        "TA_MSG_WARNING_SINGLE_AZ": "Only 1 Availability Zone is used. Multiple Availability Zone can improve fault tolerance.",
        ...
        "TA_MSG_ERROR_STATE_EDITOR_EMPTY_REQUIED_PARAMETER": "<span class='validation-tag tag-instance'>%s</span>'s <span class='validation-tag tag-state'>state %s</span> is missing required parameter <span class='validation-tag tag-parameter'>%s</span>.",
        "TA_MSG_ERROR_STATE_EDITOR_INVALID_FORMAT": "<span class='validation-tag tag-instance'>%s</span>'s <span class='validation-tag tag-state'>state %s [%s]</span> should reference a state in correct format. For example, <span class='validation-tag'>@{host1.state.3}</span>.",
        "TA_MSG_ERROR_NOT_CONNECT_OUT": "Subnet <span class='validation-tag tag-subnet'>%s</span> must be connected to internet directly or via a NAT instance. ",
        ...
        "TA_MSG_ERROR_ASG_NOTIFICATION_NO_TOPIC": "Auto Scaling Group <span class='validation-tag tag-asg'>%s</span> has configured notification. Please select a SNS Topic for it.",
        "TA_MSG_ERROR_ASG_POLICY_NO_TOPIC": "Auto Scaling Group %s's Scaling Policy <span class='validation-tag'>%s</span> has configured notification. Please select a SNS Topic for it.",
        "TA_MSG_ERROR_ASG_NOTIFICITION_TOPIC_NONEXISTENT": "Auto Scaling Group <span class='validation-tag tag-asg'>%s</span> is using a nonexistent SNS Topic <span class='validation-tag'>%s</span>. Please change to an existing SNS Topic to make notification work.",
        ...
        "TA_MSG_ERROR_RDS_AZ_NOT_CONSISTENT": "DB Instance <span class='validation-tag'>%s</span> is assigned to a Preferred AZ <span class='validation-tag'>%s</span> inconsistent with its subnet group.",
        "TA_MSG_ERROR_RDS_ACCESSIBLE_NOT_HAVE_IGW": "To allow DB instance to be publicly accessible, VPC must have an Internet Gateway.",
        "TA_MSG_ERROR_RDS_ACCESSIBLE_NOT_HAVE_DNS": "To allow DB instance to be publicly accessible, VPC must enable DNS hostnames and DNS resolution.",
        "TA_MSG_ERROR_RDS_OG_COMPATIBILITY": "App Update: Option Group compatibility.",
        "TA_MSG_WARNING_RDS_UNUSED_OG_NOT_CREATE": "Unused Option Group %s will not be created in live app.",
        "TA_MSG_ERROR_RDS_OG_EXCEED_20_LIMIT": "Region %s has reached the limit of 20 option groups.",
        "TA_MSG_ERROR_RDS_SQL_SERVER_MIRROR_MUST_HAVE3SUBNET": "DB Instance <span class='validation-tag tag-rds'>%s</span> is using SQL Server Mirroring (Multi-AZ). Its subnet group must have 3 subnets in distinct Availability Zones.",
        "TA_MSG_ERROR_RDS_BACKUP_MAINTENANCE_OVERLAP": "DB Instance <span class='validation-tag tag-rds'>%s</span> Backup Window and Maintenance Window are overlapping. Please update to avoid overlapping.",
