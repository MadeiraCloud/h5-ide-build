define({
    ...
    "ide": {
        ...
        "CVS_CFM_DEL_NONEXISTENT_DBINSTANCE": "Deleting <span class='resource-tag'>%s</span> will also remove all read replica related to it. Are you sure to continue?",
        "CVS_CFM_DEL_EXISTENT_DBINSTANCE": "%s has existed, delete it will remove read replica to related it, but keep existed replica. Are you sure to continue?",
        ...
        "PROP_INSTANCE_SNAPSHOT_SELECT": "Select Instance from which to create snapshot",
