define({
    ...
    "ide": {
        ...
        "TA_MSG_ERROR_ASG_NOTIFICATION_NO_TOPIC": "Auto Scaling Group %s has configured notification. Please select a SNS Topic for it.",
        "TA_MSG_ERROR_ASG_POLICY_NO_TOPIC": "Auto Scaling Group %s's Scaling Policy %s has configured notification. Please select a SNS Topic for it.",
        "TA_MSG_ERROR_ASG_NOTIFICITION_TOPIC_NONEXISTIENT": "Auto Scaling Group %s is using a nonexistient SNS Topic %s. Please change to an existing SNS Topic to make notification work.",
        "TA_MSG_ERROR_ASG_POLICY_TOPIC_NONEXISTIENT": "Auto Scaling Group %s's Scaling Policy %s is using a nonexistent SNS Topic %s. Please change to an existing SNS Topic to make notification work.",
