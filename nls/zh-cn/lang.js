define({
    ...
    "ide": {
        ...
        "CVS_MSG_WARN_NOTMATCH_ASG": "Auto Scaling组必须拖放到子网。",
        ...
        "CVS_MSG_WARN_NOTMATCH_IGW": "互联网网关必须拖放到VPC里。",
        "CVS_MSG_WARN_NOTMATCH_VGW": "虚拟私有网关必须拖放到VPC里。",
        "CVS_MSG_WARN_COMPONENT_OVERLAP": "节点不能互相重叠。",
        "CVS_MSG_WARN_NO_ENOUGH_SPACE": "没有多余的空间。",
        ...
        "CVS_MSG_ERR_DEL_ELB_LINE_1": "负载均衡器至少需要连接一个子网。",
        "CVS_MSG_ERR_DEL_ELB_LINE_2": "最少要保留一条已有的负载均衡器和子网的连线。",
        ...
        "TOOL_POP_BODY_DELETE_STACK": "确认删除模版'%s'吗?",
        "TOOL_POP_BTN_DELETE_STACK": "删除",
        "TOOL_POP_BTN_CANCEL": "取消",
        "TOOL_POP_EXPORT_CF": "导出为亚马逊云编排模板",
        "TOOL_POP_EXPORT_CF_INFO": "请在数据转换后下载这个云编排模板文件，并把它上传到亚马逊管理控制台来创建云编排模块。",
        "TOOL_POP_BTN_EXPORT_CF": "下载模板文件",
        "TOOL_TIP_DUPLICATE_STACK": "复制模版",
        "TOOL_TIT_CLOSE_TAB": "",
        "TOOL_POP_TIT_DUPLICATE_STACK": "复制模版",
        "TOOL_POP_BODY_DUPLICATE_STACK": "模版名称:",
        "TOOL_POP_BODY_APP_To_STACK": "模版名称:",
        "TOOL_POP_BTN_DUPLICATE_STACK": "复制",
        "TOOL_POP_BTN_SAVE_TO_STACK": "保存",
        "TOOL_TIP_CREATE_STACK": "创建新模版",
        "TOOL_TIP_ZOOM_IN": "放大",
        "TOOL_TIP_SAVE_APP_TO_STACK": "App 保存为 Stack",
        "TOOL_TIP_ZOOM_OUT": "缩小",
        "TOOL_EXPORT": "导出...",
        "TOOL_EXPORT_AS_JSON": "导出JSON文件",
        "TOOL_POP_TIT_EXPORT_AS_JSON": "导出",
        "TOOL_POP_TIT_APP_TO_STACK": "将 App 保存为 Stack",
        "TOOL_POP_INTRO_1": "",
        "TOOL_POP_INTRO_2": "",
        ...
        "TOOL_POP_TIT_STOP_PRD_APP": "确认暂停产品应用",
        ...
        "TOOL_TIP_UPDATE_APP": "更新应用",
        "TOOL_TIP_SAVE_UPDATE_APP": "保存应用更新",
        "TOOL_TIP_CANCEL_UPDATE_APP": "取消应用更新",
        ...
        "TOOL_POP_TIT_TERMINATE_PRD_APP": "确认销毁产品应用",
        ...
        "TOOL_POP_BODY_APP_UPDATE_EC2": "重启后，公有/私有的IP地址将会被重新分配。",
        "TOOL_POP_BODY_APP_UPDATE_VPC": "重启后，已分配公有IP地址的实例将会被重新分配。",
        ...
        "TOOL_TIP_LINESTYLE": "连线类型",
        "TOOL_LBL_LINESTYLE_STRAIGHT": "直线",
        "TOOL_LBL_LINESTYLE_ELBOW": "折线",
        "TOOL_LBL_LINESTYLE_CURVE": "曲线",
        "TOOL_LBL_LINESTYLE_SMOOTH_QUADRATIC_BELZIER": "光滑的二次贝塞尔曲线",
        "TOOL_LBL_LINESTYLE_HIDE_SG": "隐藏SecurityGroup线",
        "TOOL_LBL_LINESTYLE_SHOW_SG": "显示SecurityGroup线",
        "TOOL_EXPERIMENT": "",
        ...
        "PROP_CGW_APP_VPN_LBL_STATUS_RT": "静态路由",
        ...
        "PROP_VOLUME_TYPE_STANDARD": "传统磁盘",
        "PROP_VOLUME_TYPE_GP2": "通用（SSD）",
        "PROP_VOLUME_TYPE_IO1": "预配置IOPS",
        ...
        "PROP_ASG_LBL_SEND_NOTIFICATION_D": "通过SNS发送通知",
        ...
        "PROP_ASG_ADD_POLICY_SECONDS": "分时，进入警报状态",
