  ...
  AwsOpsModel = OpsModel.extend({
    ...
    ___mesosJson: function(scale) {
      ...
      simpleMesosMap = {
        small: {
          component: {
            "CC4D5367-C89A-495F-939D-A1528ECCE0D5": {
              "name": "mesos",
              "description": "",
              "type": "AWS.VPC.VPC",
              "uid": "CC4D5367-C89A-495F-939D-A1528ECCE0D5",
              "resource": {
                "EnableDnsSupport": true,
                "InstanceTenancy": "default",
                "EnableDnsHostnames": false,
            ...
            "68E2E996-0DC9-485D-B510-27067F1AFB0E": {
              "type": "AWS.AutoScaling.LaunchConfiguration",
              "uid": "68E2E996-0DC9-485D-B510-27067F1AFB0E",
              "name": "slave-lc-0",
              "description": "",
              "state": [
                {
                  ...
                  "parameter": {
                    "masters_addresses": [
                      {
                        "key": "@{646F4EE6-C29A-4360-9E49-207F3324DF06.PrivateIpAddress}",
                        "value": "master-0"
                      }, {
                        "key": "@{A57E0C17-4B26-4EA2-B516-E072896755B6.PrivateIpAddress}",
                        "value": "master-1"
                      }, {
                        "key": "@{F3C9F90F-DE02-4BD0-A41F-061D45030A86.PrivateIpAddress}",
                        "value": "master-2"
                      }
                    ],
                    "attributes": [
              ...
              "resource": {
                ...
                "KeyName": "@{A7ABCFCE-99C2-45D5-B740-981FD47B3F22.resource.KeyName}",
                "EbsOptimized": false,
                "BlockDeviceMapping": [
                  {
                    "DeviceName": "/dev/sda1",
                ...
                "SecurityGroups": ["@{AEFE32F3-1F20-4C07-BE63-E707B9D9D1B4.resource.GroupId}"],
                "LaunchConfigurationName": "slave-lc-0",
                "InstanceType": "t2.small",
                "AssociatePublicIpAddress": true
              }
            },
            "BD1BF339-BDD6-4ADE-B4B7-6B2EA67B9934": {
              "name": "RT-0",
              "description": "",
              "type": "AWS.VPC.RouteTable",
              "uid": "BD1BF339-BDD6-4ADE-B4B7-6B2EA67B9934",
              "resource": {
                "PropagatingVgwSet": [],
                "RouteTableId": "",
                "VpcId": "@{CC4D5367-C89A-495F-939D-A1528ECCE0D5.resource.VpcId}",
                "AssociationSet": [
                  {
                    "Main": "true",
                    "RouteTableAssociationId": "",
                ...
                "RouteSet": [
                  {
                    ...
                    "InstanceId": "",
                    "NetworkInterfaceId": "",
                    "GatewayId": "@{CABCA54F-1CF0-4391-A0A3-9ED7D72A65FB.resource.InternetGatewayId}"
                  }
                ],
                "Tags": [
                  {
            ...
            "2291AF61-5EA2-4EA6-AC31-74425CC7D1C6": {
              "name": "DefaultACL",
              "type": "AWS.VPC.NetworkAcl",
              "uid": "2291AF61-5EA2-4EA6-AC31-74425CC7D1C6",
              "resource": {
                "AssociationSet": [
                  {
                    "NetworkAclAssociationId": "",
                    "SubnetId": "@{4BFF1F41-39B2-4B72-BCF3-3F7287B7D967.resource.SubnetId}"
                  }, {
                    "NetworkAclAssociationId": "",
                    "SubnetId": "@{4A77F289-9023-4D18-9EB3-8B7A2CF4E8EF.resource.SubnetId}"
                  }, {
                    "NetworkAclAssociationId": "",
                    "SubnetId": "@{C893BAB4-8C3D-4389-AC50-D24B103D4DB7.resource.SubnetId}"
                  }, {
                    "NetworkAclAssociationId": "",
                    "SubnetId": "@{CB65826B-70DB-4139-A547-827160CA0C75.resource.SubnetId}"
                  }
                ],
                "Default": true,
                "EntrySet": [
            ...
            "E7DD1772-5CE5-437E-B3D7-7454A6D1B1CC": {
              "uid": "E7DD1772-5CE5-437E-B3D7-7454A6D1B1CC",
              "name": "us-east-1b",
            ...
            "4BFF1F41-39B2-4B72-BCF3-3F7287B7D967": {
              "name": "sched-b",
              "description": "",
              "type": "AWS.VPC.Subnet",
              "uid": "4BFF1F41-39B2-4B72-BCF3-3F7287B7D967",
              "resource": {
                "AvailabilityZone": "@{E7DD1772-5CE5-437E-B3D7-7454A6D1B1CC.resource.ZoneName}",
                "VpcId": "@{CC4D5367-C89A-495F-939D-A1528ECCE0D5.resource.VpcId}",
                "SubnetId": "",
                "CidrBlock": "10.0.3.0/24"
              }
            },
            "03C1AC36-441E-4E0B-8D3F-8FEC3DC02396": {
              "uid": "03C1AC36-441E-4E0B-8D3F-8FEC3DC02396",
              "name": "us-east-1a",
              "type": "AWS.EC2.AvailabilityZone",
              "resource": {
                "ZoneName": "us-east-1a",
            ...
            "4A77F289-9023-4D18-9EB3-8B7A2CF4E8EF": {
              "name": "slave-a",
              "description": "",
              "type": "AWS.VPC.Subnet",
              "uid": "4A77F289-9023-4D18-9EB3-8B7A2CF4E8EF",
              "resource": {
                "AvailabilityZone": "@{03C1AC36-441E-4E0B-8D3F-8FEC3DC02396.resource.ZoneName}",
                "VpcId": "@{CC4D5367-C89A-495F-939D-A1528ECCE0D5.resource.VpcId}",
                "SubnetId": "",
                "CidrBlock": "10.0.0.0/24"
              }
            },
            "92509E5E-8915-45C9-AEDF-E3E8672DFAAF": {
              "uid": "92509E5E-8915-45C9-AEDF-E3E8672DFAAF",
              "name": "slave-asg",
              "description": "",
              "type": "AWS.AutoScaling.Group",
              "resource": {
                "AvailabilityZones": ["@{03C1AC36-441E-4E0B-8D3F-8FEC3DC02396.resource.ZoneName}", "@{E7DD1772-5CE5-437E-B3D7-7454A6D1B1CC.resource.ZoneName}"],
                "VPCZoneIdentifier": "@{4A77F289-9023-4D18-9EB3-8B7A2CF4E8EF.resource.SubnetId} , @{CB65826B-70DB-4139-A547-827160CA0C75.resource.SubnetId}",
                "LoadBalancerNames": [],
                "AutoScalingGroupARN": "",
                "DefaultCooldown": "300",
                "MinSize": "5",
                ...
                "DesiredCapacity": "5",
                "LaunchConfigurationName": "@{68E2E996-0DC9-485D-B510-27067F1AFB0E.resource.LaunchConfigurationName}"
              }
            },
            "C893BAB4-8C3D-4389-AC50-D24B103D4DB7": {
              "name": "sched-a",
              "description": "",
              "type": "AWS.VPC.Subnet",
              "uid": "C893BAB4-8C3D-4389-AC50-D24B103D4DB7",
              "resource": {
                "AvailabilityZone": "@{03C1AC36-441E-4E0B-8D3F-8FEC3DC02396.resource.ZoneName}",
                "VpcId": "@{CC4D5367-C89A-495F-939D-A1528ECCE0D5.resource.VpcId}",
                "SubnetId": "",
            ...
            "646F4EE6-C29A-4360-9E49-207F3324DF06": {
              "type": "AWS.EC2.Instance",
              "uid": "646F4EE6-C29A-4360-9E49-207F3324DF06",
              "name": "master-0",
              "description": "",
              "index": 0,
              "number": 1,
              "serverGroupUid": "646F4EE6-C29A-4360-9E49-207F3324DF06",
            ...
            "D29FEFA0-F974-4382-874A-C78BB44E069A": {
              "index": 0,
              "uid": "D29FEFA0-F974-4382-874A-C78BB44E069A",
              "type": "AWS.VPC.NetworkInterface",
              "name": "master-0-eni0",
              "serverGroupUid": "D29FEFA0-F974-4382-874A-C78BB44E069A",
              ...
              "resource": {
                ...
                "GroupSet": [
                  {
                    "GroupName": "@{AEFE32F3-1F20-4C07-BE63-E707B9D9D1B4.resource.GroupName}",
                    "GroupId": "@{AEFE32F3-1F20-4C07-BE63-E707B9D9D1B4.resource.GroupId}"
                  }, {
                    "GroupName": "@{3BEE3B7B-2D0D-4325-8958-0E9E9F4CB781.resource.GroupName}",
                    "GroupId": "@{3BEE3B7B-2D0D-4325-8958-0E9E9F4CB781.resource.GroupId}"
                  }
                ],
                "Attachment": {
                  "InstanceId": "@{646F4EE6-C29A-4360-9E49-207F3324DF06.resource.InstanceId}",
                  "DeviceIndex": "0",
                  "AttachmentId": ""
                }
              }
            },
            "A7ABCFCE-99C2-45D5-B740-981FD47B3F22": {
              "name": "DefaultKP",
              "type": "AWS.EC2.KeyPair",
              "uid": "A7ABCFCE-99C2-45D5-B740-981FD47B3F22",
              "resource": {
                "KeyFingerprint": "",
                "KeyName": ""
              }
            },
            "F3C9F90F-DE02-4BD0-A41F-061D45030A86": {
              "type": "AWS.EC2.Instance",
              "uid": "F3C9F90F-DE02-4BD0-A41F-061D45030A86",
              "name": "master-2",
              "description": "",
              "index": 0,
              "number": 1,
              "serverGroupUid": "F3C9F90F-DE02-4BD0-A41F-061D45030A86",
            ...
            "EA4DF7A4-9B65-4850-BA30-41CB277C8BA5": {
              "index": 0,
              "uid": "EA4DF7A4-9B65-4850-BA30-41CB277C8BA5",
              "type": "AWS.VPC.NetworkInterface",
              "name": "master-2-eni0",
              "serverGroupUid": "EA4DF7A4-9B65-4850-BA30-41CB277C8BA5",
              "serverGroupName": "eni0",
              "number": 1,
              "resource": {
                "SourceDestCheck": true,
                ...
                "Attachment": {
                  "InstanceId": "@{F3C9F90F-DE02-4BD0-A41F-061D45030A86.resource.InstanceId}",
                  "DeviceIndex": "0",
                  "AttachmentId": ""
                }
              }
            },
            "AEFE32F3-1F20-4C07-BE63-E707B9D9D1B4": {
              "name": "MesosSG",
              "type": "AWS.EC2.SecurityGroup",
              "uid": "AEFE32F3-1F20-4C07-BE63-E707B9D9D1B4",
              "resource": {
                "Default": false,
                "GroupId": "",
                "GroupName": "MesosSG",
                ...
                "IpPermissions": [
                  {
                    "FromPort": "0",
                    "ToPort": "65535",
                    "IpRanges": "@{AEFE32F3-1F20-4C07-BE63-E707B9D9D1B4.resource.GroupId}",
                    "IpProtocol": "-1"
                  }
                ],
                "IpPermissionsEgress": [
            ...
            "3BEE3B7B-2D0D-4325-8958-0E9E9F4CB781": {
              "name": "MesosMaster",
              "type": "AWS.EC2.SecurityGroup",
              "uid": "3BEE3B7B-2D0D-4325-8958-0E9E9F4CB781",
              "resource": {
                "Default": false,
                "GroupId": "",
            ...
            "A57E0C17-4B26-4EA2-B516-E072896755B6": {
              "type": "AWS.EC2.Instance",
              "uid": "A57E0C17-4B26-4EA2-B516-E072896755B6",
              "name": "master-1",
              "description": "",
              "index": 0,
              "number": 1,
              "serverGroupUid": "A57E0C17-4B26-4EA2-B516-E072896755B6",
            ...
            "CA748681-7AEA-4DF9-9745-584B3A1A8699": {
              "index": 0,
              "uid": "CA748681-7AEA-4DF9-9745-584B3A1A8699",
              "type": "AWS.VPC.NetworkInterface",
              "name": "master-1-eni0",
              "serverGroupUid": "CA748681-7AEA-4DF9-9745-584B3A1A8699",
              "serverGroupName": "eni0",
              "number": 1,
              "resource": {
                "SourceDestCheck": true,
                ...
                "Attachment": {
                  "InstanceId": "@{A57E0C17-4B26-4EA2-B516-E072896755B6.resource.InstanceId}",
                  "DeviceIndex": "0",
                  "AttachmentId": ""
                }
              }
            },
            "CB65826B-70DB-4139-A547-827160CA0C75": {
              "name": "slave-b",
              "description": "",
              "type": "AWS.VPC.Subnet",
              "uid": "CB65826B-70DB-4139-A547-827160CA0C75",
              "resource": {
                "AvailabilityZone": "@{E7DD1772-5CE5-437E-B3D7-7454A6D1B1CC.resource.ZoneName}",
                "VpcId": "@{CC4D5367-C89A-495F-939D-A1528ECCE0D5.resource.VpcId}",
                "SubnetId": "",
            ...
            "2826ADFA-B805-43FB-B866-3F1F0DC48021": {
              "name": "cpu-policy",
              "type": "AWS.AutoScaling.ScalingPolicy",
              "uid": "2826ADFA-B805-43FB-B866-3F1F0DC48021",
              "resource": {
                "ScalingAdjustment": "5",
                "PolicyName": "cpu-policy",
                "PolicyARN": "",
                "Cooldown": "300",
                "AutoScalingGroupName": "@{92509E5E-8915-45C9-AEDF-E3E8672DFAAF.resource.AutoScalingGroupName}",
                "AdjustmentType": "ChangeInCapacity",
                "MinAdjustmentStep": ""
              }
            },
            "0BED7F7F-D895-4488-B809-F2DFA6712F20": {
              "name": "cpu-policy-alarm",
              "type": "AWS.CloudWatch.CloudWatch",
              "uid": "0BED7F7F-D895-4488-B809-F2DFA6712F20",
              "resource": {
                "AlarmArn": "",
                ...
                "Dimensions": [
                  {
                    ...
                    "value": "@{92509E5E-8915-45C9-AEDF-E3E8672DFAAF.resource.AutoScalingGroupName}"
                  }
                ],
                "AlarmActions": ["@{2826ADFA-B805-43FB-B866-3F1F0DC48021.resource.PolicyARN}"],
                "InsufficientDataActions": [],
                "OKAction": []
              }
            },
            "1EA0F0C9-6122-488D-946F-561B68E63A3A": {
              "name": "DefaultSG",
              "type": "AWS.EC2.SecurityGroup",
              "uid": "1EA0F0C9-6122-488D-946F-561B68E63A3A",
              "resource": {
                "Default": true,
                "GroupId": "",
                "GroupName": "DefaultSG",
            ...
            "CABCA54F-1CF0-4391-A0A3-9ED7D72A65FB": {
              "name": "Internet-gateway",
              "type": "AWS.VPC.InternetGateway",
              "uid": "CABCA54F-1CF0-4391-A0A3-9ED7D72A65FB",
              "resource": {
                "InternetGatewayId": "",
                "AttachmentSet": [
                  {
