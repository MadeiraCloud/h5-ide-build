...
require.config({
  ...
  bundles: {
    ...
    "component/AwsComps": ['dhcp', 'kp_dropdown', 'kp_manage', 'kp_upload', 'sns_dropdown', 'sns_manage', 'dhcp_manage', 'snapshotManager', 'rds_pg', 'rds_snapshot', 'tag_manager', 'sslcert_manage', 'sslcert_dropdown', 'og_manage', 'og_manage_app', 'og_dropdown', 'SGRulePopup', 'DbSubnetGPopup', 'FilterInput'],
