  ...
  define('ide/cloudres/CloudImportVpc',["CloudResources", "ide/cloudres/CrCollection", "constant", "ApiRequest", "DiffTree"], function(CloudResources, CrCollection, constant, ApiRequest, DiffTree) {
    ...
    Converters = [
      function() {
        ...
        var aws_vpn, cgwComp, route, vgwComp, vpnComp, vpnRes, _i, _j, _len, _len1, _ref, _ref1, _ref2;
        ...
        var aws_sg, genRules, groupId, originSGComp, sgComp, sgRefMap, sgRes, sg_rule, vpcComp, _i, _j, _k, _l, _len, _len1, _len2, _len3, _ref, _ref1, _ref2, _ref3;
        sgRefMap = {};
        genRules = function(sg_rule, new_ruls) {
          var ipranges, sgComp, sgId;
          ipranges = '';
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          this.component[volComp.uid] = volComp;
        }
      }, function() {
        var aws_asg, aws_ins, azComp, insComp, insRes, keyPairComp, me, originComp, subnetComp, vol_in_instance, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;
        me = this;
        ...
        for (_i = 0, _len = _ref.length; _i < _len; _i++) {
          ...
          if (aws_eni.attachment.instanceOwnerId && ((_ref1 = aws_eni.attachment.instanceOwnerId) === "amazon-elb" || _ref1 === "amazon-rds")) {
            continue;
          }
          ...
          eniComp = this.add("ENI", eniRes, "eni" + aws_eni.attachment.deviceIndex);
          this.enis[aws_eni.id] = eniComp;
          if (!((_ref5 = aws_eni.attachment.deviceIndex) === "0" || _ref5 === 0)) {
