  ...
  define('ide/cloudres/CloudImportVpc',["CloudResources", "ide/cloudres/CrCollection", "constant", "ApiRequest", "DiffTree"], function(CloudResources, CrCollection, constant, ApiRequest, DiffTree) {
    ...
    Converters = [
      function() {
        ...
        var aws_asg, aws_ins, azComp, insComp, insRes, keyPairComp, me, originComp, rootDeviceAry, subnetComp, vol_in_instance, _i, _j, _len, _len1, _ref, _ref1, _ref2, _ref3;
        me = this;
        ...
        for (_j = 0, _len1 = _ref1.length; _j < _len1; _j++) {
          ...
          if (keyPairComp) {
            ...
            if (aws_ins.keyName) {
              ...
              insRes.KeyName = CREATE_REF(this.DEFAULT_KP, "resource.KeyName");
            }
          }
          vol_in_instance = [];
