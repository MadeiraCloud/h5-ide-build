  ...
  define('workspaces/editor/subviews/Toolbar',["OpsModel", "../template/TplOpsEditor", "ThumbnailUtil", "JsonExporter", "ApiRequest", "i18n!/nls/lang.js", "UI.modalplus", 'kp_dropdown', "ResDiff", 'constant', 'event', 'component/trustedadvisor/gui/main', "CloudResources", "appAction", "UI.notification", "backbone"], function(OpsModel, OpsEditorTpl, Thumbnail, JsonExporter, ApiRequest, lang, Modal, kpDropdown, ResDiff, constant, ide_event, TA, CloudResources, appAction) {
    ...
    return Backbone.View.extend({
      ...
      __runStack: function(paymentUpdate, paymentModal) {
        var appNameDom, checkAppNameRepeat, cost, paymentState, self, that;
        that = this;
        ...
        this.modal.find("#label-total-fee").find('b').text("$" + cost.totalFee);
      ...
      applyAppEdit: function() {
        ...
        return this.checkDBinstance(oldDBInstanceList).then(function(DBInstances) {
          var $diffTree, cost, notAvailableDB, removeList, removeListNotReady;
...
(function() {
  define('workspaces/editor/canvas/CanvasManager',['CloudResources', 'constant'], function(CloudResources, constant) {
    var CanvasManager;
    CanvasManager = {
...
(function() {
  define('workspaces/editor/canvas/CanvasViewConnect',["./CanvasView", "Design", "./CanvasManager", "./CanvasElement", "i18n!/nls/lang.js", "UI.modalplus"], function(CanvasView, Design, CanvasManager, CanvasElement, lang, Modal) {
...
(function() {
  define('workspaces/editor/canvas/CeInstance',["./CanvasElement", "constant", "./CanvasManager", "./CpVolume", "./CpInstance", "i18n!/nls/lang.js", "CloudResources", "event", "UI.notification"], function(CanvasElement, constant, CanvasManager, VolumePopup, InstancePopup, lang, CloudResources, ide_event) {
    return CanvasElement.extend({
...
(function() {
  define('workspaces/editor/OpsViewApp',["./OpsViewBase", "OpsModel", "./template/TplOpsEditor", "UI.modalplus", "i18n!/nls/lang.js", "appAction"], function(OpsViewBase, OpsModel, OpsEditorTpl, Modal, lang, AppAction) {
